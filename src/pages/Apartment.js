    ...
    <div className="row">
      ...
      <div className="col-lg-7 col-md-7 col-sm-12 text-md-right">
        ...
        <li className="breadcrumb-item"><a href="/home"><i className="zmdi zmdi-home" /> Meta</a></li>
          <li className="breadcrumb-item active">Apartment</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div className="row clearfix">
      <div className="col-xl-3 col-lg-4 col-md-6">
        <div className="card card_type">
          ...
          <div className="body">                        
            <h5 className="mt-0"><NavLink to="#" className="col-blue-grey">Nirala Appartment</NavLink></h5>
            ...
            <div className="d-flex justify-content-between mt-3 p-3 bg-light">
              <NavLink to="#" title="Square Feet"><i className="zmdi zmdi-view-dashboard mr-2" /><span>280</span></NavLink>
              <NavLink to="#" title="Bedroom"><i className="zmdi zmdi-hotel mr-2" /><span>4</span></NavLink>
              <NavLink to="#" title="Parking space"><i className="zmdi zmdi-car-taxi mr-2" /><span>2</span></NavLink>
              <NavLink to="#" title="Garages"><i className="zmdi zmdi-home mr-2" /><span> 24H</span></NavLink>
            </div>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6">
        <div className="card card_type">
          ...
          <div className="body">                        
            <h5 className="mt-0"><NavLink to="#" className="col-blue-grey">Modern Family Home</NavLink></h5>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6">
        <div className="card card_type">
          ...
          <div className="body">                        
            <h5 className="mt-0"><NavLink to="#" className="col-blue-grey">Office Floor</NavLink></h5>
            <small className="text-muted"><i className="zmdi zmdi-pin mr-2" />245 E 20th St, New York, NY 201609</small>
            <div className="d-flex justify-content-between mt-3 p-3 bg-light">
              <NavLink to="#" title="Square Feet"><i className="zmdi zmdi-view-dashboard mr-2" /><span>280</span></NavLink>
              <NavLink to="#" title="Bedroom"><i className="zmdi zmdi-hotel mr-2" /><span>4</span></NavLink>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6">
        <div className="card card_type">
          ...
          <div className="body">                        
            <h5 className="mt-0"><NavLink to="#" className="col-blue-grey">Relaxing Apartment</NavLink></h5>
            <small className="text-muted"><i className="zmdi zmdi-pin mr-2" />Avenue South Burlington, Los Angles</small>
            <div className="d-flex justify-content-between mt-3 p-3 bg-light">
              <NavLink to="#" title="Square Feet"><i className="zmdi zmdi-view-dashboard mr-2" /><span>280</span></NavLink>
              <NavLink to="#" title="Bedroom"><i className="zmdi zmdi-hotel mr-2" /><span>4</span></NavLink>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6">
        <div className="card card_type">
          ...
          <div className="body">                        
            <h5 className="mt-0"><NavLink to="#" className="col-blue-grey">Apolo Family Appartment</NavLink></h5>
            <small className="text-muted"><i className="zmdi zmdi-pin mr-2" />245 E 20th St, New York, NY 201609</small>
            <div className="d-flex justify-content-between mt-3 p-3 bg-light">
              <NavLink to="#" title="Square Feet"><i className="zmdi zmdi-view-dashboard mr-2" /><span>280</span></NavLink>
              <NavLink to="#" title="Bedroom"><i className="zmdi zmdi-hotel mr-2" /><span>4</span></NavLink>
